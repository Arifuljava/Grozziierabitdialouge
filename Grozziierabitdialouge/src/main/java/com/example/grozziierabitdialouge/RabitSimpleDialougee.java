...
public class RabitSimpleDialougee extends Dialog {
    Context context;
    ...
    public RabitSimpleDialougee(Context context) {
        super(context);
      ...
      getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        ...
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.simpledilouge);
        /////
    ...
    public RabitSimpleDialougee setTitle(String titleText) {
        textdet.setVisibility(View.VISIBLE);
        textdet.setText(titleText);
        return this;
    }
    public RabitSimpleDialougee setTitleColor(int color) {
        textdet.setVisibility(View.VISIBLE);
    ...
    public RabitSimpleDialougee isCancelable(boolean cancelable){
        this.setCancelable(cancelable);
        return this;
    }
    public RabitSimpleDialougee setIcon(int  image)
    {
        deviceanimation__1.setVisibility(View.VISIBLE);
        deviceanimation__1.setImageResource(image);
      return  this;
    }
    public RabitSimpleDialougee setMessage(String message) {
        justift.setVisibility(View.VISIBLE);
        justift.setText(message);
        return  this;
    }

    public RabitSimpleDialougee setSubtitleColor(int color)
    {
        justift.setVisibility(View.VISIBLE);
        justift.setTextColor(color);
        return this;
    }
    public RabitSimpleDialougee yesbuttonText(String text)
    {
        yesbutton.setVisibility(View.VISIBLE);
        yesbutton.setText(text);
        return this;
    }
    public RabitSimpleDialougee nobuttonText(String text)
    {
        nobutton.setVisibility(View.VISIBLE);
        nobutton.setText(text);
        return this;
    }
    public RabitSimpleDialougee yesbuttonTextColor(int color)
    {
        yesbutton.setVisibility(View.VISIBLE);
    ...
    public RabitSimpleDialougee nobuttonTextColor(int color)
    {
        nobutton.setVisibility(View.VISIBLE);
   ...
   public RabitSimpleDialougee setyesbuttonClicklistener(String message, View.OnClickListener configlistener)
   {
       yesbutton.setVisibility(View.VISIBLE);
   ...
   public RabitSimpleDialougee setnobuttonClicklisener(String message, View.OnClickListener configlistener)
   {
       nobutton.setVisibility(View.VISIBLE);
   ...
   public RabitSimpleDialougee closeOnclicklistener(View.OnClickListener configlistener)
   {
