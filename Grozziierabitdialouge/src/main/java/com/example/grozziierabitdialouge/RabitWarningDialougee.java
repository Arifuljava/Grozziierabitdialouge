...
public class RabitWarningDialougee extends Dialog {
    Context context;
    ...
    public RabitWarningDialougee(Context context) {
        super(context);
      ...
      getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        ...
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.warnign);
        /////
    ...
    public RabitWarningDialougee setTitle(String titleText) {
        textdet.setVisibility(View.VISIBLE);
        textdet.setText(titleText);
        return this;
    }
    public RabitWarningDialougee setTitleColor(int color) {
        textdet.setVisibility(View.VISIBLE);
    ...
    public RabitWarningDialougee isCancelable(boolean cancelable){
        this.setCancelable(cancelable);
        return this;
    }
    public RabitWarningDialougee setIcon(int  image)
    {
        deviceanimation__1.setVisibility(View.VISIBLE);
        deviceanimation__1.setImageResource(image);
      return  this;
    }
    public RabitWarningDialougee setMessage(String message) {
        justift.setVisibility(View.VISIBLE);
        justift.setText(message);
        return  this;
    }

    public RabitWarningDialougee setSubtitleColor(int color)
    {
        justift.setVisibility(View.VISIBLE);
        justift.setTextColor(color);
        return this;
    }
    public RabitWarningDialougee yesbuttonText(String text)
    {
        yesbutton.setVisibility(View.VISIBLE);
        yesbutton.setText(text);
        return this;
    }
    public RabitWarningDialougee nobuttonText(String text)
    {
        nobutton.setVisibility(View.VISIBLE);
        nobutton.setText(text);
        return this;
    }
    public RabitWarningDialougee yesbuttonTextColor(int color)
    {
        yesbutton.setVisibility(View.VISIBLE);
    ...
    public RabitWarningDialougee nobuttonTextColor(int color)
    {
        nobutton.setVisibility(View.VISIBLE);
   ...
   public RabitWarningDialougee setyesbuttonClicklistener(String message, View.OnClickListener configlistener)
   {
       yesbutton.setVisibility(View.VISIBLE);
   ...
   public RabitWarningDialougee setnobuttonClicklisener(String message, View.OnClickListener configlistener)
   {
       nobutton.setVisibility(View.VISIBLE);
   ...
   public RabitWarningDialougee closeOnclicklistener(View.OnClickListener configlistener)
   {
