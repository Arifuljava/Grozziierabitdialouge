...
public class RabitInfoDialouge extends Dialog {
    ...
    public RabitInfoDialouge setTitle(String titleText) {
        textdet.setVisibility(View.VISIBLE);
        textdet.setText(titleText);
        return this;
    }
    public RabitInfoDialouge setTitleColor(int color) {
        textdet.setVisibility(View.VISIBLE);
    ...
    public RabitInfoDialouge isCancelable(boolean cancelable){
        this.setCancelable(cancelable);
        return this;
    }
    public RabitInfoDialouge setIcon(int  image)
    {
        deviceanimation__1.setVisibility(View.VISIBLE);
        deviceanimation__1.setImageResource(image);
        return  this;
    }
    public RabitInfoDialouge setMessage(String message) {
        justift.setVisibility(View.VISIBLE);
        justift.setText(message);
        return  this;
    }

    public RabitInfoDialouge setSubtitleColor(int color)
    {
        justift.setVisibility(View.VISIBLE);
        justift.setTextColor(color);
        return this;
    }
    public RabitInfoDialouge yesbuttonText(String text)
    {
        yesbutton.setVisibility(View.VISIBLE);
        yesbutton.setText(text);
        return this;
    }
    public RabitInfoDialouge nobuttonText(String text)
    {
        nobutton.setVisibility(View.VISIBLE);
        nobutton.setText(text);
        return this;
    }
    public RabitInfoDialouge yesbuttonTextColor(int color)
    {
        yesbutton.setVisibility(View.VISIBLE);
    ...
    public RabitInfoDialouge nobuttonTextColor(int color)
    {
        nobutton.setVisibility(View.VISIBLE);
    ...
    public RabitInfoDialouge setyesbuttonClicklistener(String message, View.OnClickListener configlistener)
    {
        yesbutton.setVisibility(View.VISIBLE);
    ...
    public RabitInfoDialouge setnobuttonClicklisener(String message, View.OnClickListener configlistener)
    {
        nobutton.setVisibility(View.VISIBLE);
    ...
    public RabitInfoDialouge closeOnclicklistener(View.OnClickListener configlistener)
    {
